...
const MOCK_POSTS: Post[] = [
  {
    ...
    content: "✨ Transformação completa! Mechas iluminadas + hidratação profunda para dar vida aos cabelos da nossa cliente. Resultado incrível que combina perfeitamente com seu tom de pele. Agende seu horário e renove seu visual! 💇‍♀️✨",
    ...
    linkedService: {
      id: "s1",
      name: "Mechas Iluminadas + Hidratação",
      description: "Transformação completa com mechas iluminadas e tratamento hidratante profissional para um resultado deslumbrante.",
      price: 450,
      duration: 240,
      image: "https://images.unsplash.com/photo-1560869713-da86bd4b3bd6?q=80&w=1472&auto=format&fit=crop",
    },
  },
  {
    id: "2",
